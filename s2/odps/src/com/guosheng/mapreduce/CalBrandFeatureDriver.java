...
public class CalBrandFeatureDriver {
	...
	public static void main(String[] args) throws OdpsException {
		...
		job.setMapperClass(com.guosheng.mapreduce.CalBrandFeatureMap.class);
		job.setReducerClass(com.guosheng.mapreduce.CalBrandFeatureReduce.class);
